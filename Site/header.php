...
<head>
    ...
    <script src="/wp-content/themes/Avada-Child-Theme/clipboard.min.js"></script>
    <script src="/wp-content/themes/Avada-Child-Theme/common.js"></script>
    <script src="/wp-content/themes/Avada-Child-Theme/web3.min.js"></script>
    <script src="/wp-content/themes/Avada-Child-Theme/eth_homepage.js"></script>
    <script src="/wp-content/themes/Avada-Child-Theme/eth_profile.js"></script>

	<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-114057066-5"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-114057066-5');
</script>
...
?>
    <span style="display: none" class="eth_price_usd"><?=$eth[0]['price_usd']?></span>
    <span style="display: none" class="user_acc_number"><?=get_user_meta(get_current_user_id(), 'ETHWallet', true)?></span>
